...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.createOrReplaceGoalStmt, err = db.PrepareContext(ctx, createOrReplaceGoal); err != nil {
		return nil, fmt.Errorf("error preparing query CreateOrReplaceGoal: %w", err)
	}
	...
	if q.deleteGoalStmt, err = db.PrepareContext(ctx, deleteGoal); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteGoal: %w", err)
	}
	...
	if q.getGoalByScopeIDStmt, err = db.PrepareContext(ctx, getGoalByScopeID); err != nil {
...
func (q *Queries) Close() error {
	...
	if q.createOrReplaceGoalStmt != nil {
		if cerr := q.createOrReplaceGoalStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing createOrReplaceGoalStmt: %w", cerr)
		}
	}
	...
	if q.deleteGoalStmt != nil {
		if cerr := q.deleteGoalStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteGoalStmt: %w", cerr)
		}
	}
	...
	if q.getGoalByScopeIDStmt != nil {
		if cerr := q.getGoalByScopeIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getGoalByScopeIDStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	createOrReplaceGoalStmt        *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		createOrReplaceGoalStmt:        q.createOrReplaceGoalStmt,
		...
		getGoalByScopeIDStmt:           q.getGoalByScopeIDStmt,
